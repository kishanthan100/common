...
class Connect:
    ...
    def get_logged_user(self):
        if self.auth_session:
            return self.auth_session.get(
                f"{self.host}/method/get_logged_user"
            ).status_code
        return False
...
#     # Create an instance of the SecondClass
#     connection = Connect()
#     connection.login() 
#     api=API()
#     results=api.get_dataframe("Delivery Note")
#     print("results of result",results)
#     # Run the method from SecondClass
